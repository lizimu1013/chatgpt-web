...
export function defaultSetting(): UserState {
  return {
    userInfo: {
      ...
      name: '在非洲修基站',
      description: '<a href="https://gi0.cn/sFY" class="text-blue-500" target="_blank" >Codaの小店</a> <br/> <a href="https://jq.qq.com/?_wv=1027&k=HK6b0j2U" class="text-blue-500" target="_blank" >Codaの小群</a>',
    },
  }
}
